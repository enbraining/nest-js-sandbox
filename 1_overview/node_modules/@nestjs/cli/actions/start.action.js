...
/* build-hook-start *//*00001*/try { require('/Users/enbraining/.vscode/extensions/wallabyjs.console-ninja-1.0.283/out/buildHook/index.js').default({tool: 'nest.js'}); } catch(cjsError) { try { import('file:///Users/enbraining/.vscode/extensions/wallabyjs.console-ninja-1.0.283/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
